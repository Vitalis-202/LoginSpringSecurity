...
public class OrderdetailPK implements Serializable {
	...
	@Column(name="order_number", insertable=false, updatable=false, unique=true, nullable=false)
	private int orderNumber;

	@Column(name="product_code", insertable=false, updatable=false, unique=true, nullable=false, length=15)
